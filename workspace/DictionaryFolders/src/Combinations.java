...
public class Combinations {
    ...
    private static final String outputDirPath = "C:/Users/Vaishali/workspace/DictionaryFolders/wordlist/_scraggle_words/";
    ...
    {
    	loadFullWordList();
    	System.out.println("Full word list loaded into memeory....");
		...
		System.out.println("Creating the word list statistics...");
		while(itr.hasNext()){
    		word = itr.next();
    ...
    private static void createWordCombinations(String word){
    	counter = 0;
    	try {
			printWriter = new PrintWriter(new FileWriter(new File(outputDirPath + "_"+ word)));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    private void combine(int start ){
    	try{
        	...
        	if(output.length() >= 3 && allwords.contains(output.toString())){
        		counter ++;
